                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="number" id="number" placeholder="Número"
                                value="<?= isset($student) ? $student['number'] : "" ?>" required>
                        </div>
                    </div>
                </div>
                <div class='row'>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="district" id="district" placeholder="Bairro"
                                value="<?= isset($student) ? $student['district'] : "" ?>" required></input>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="complement" id="complement"
                                value="<?= isset($student) ? $student['complement'] : "" ?>" placeholder="Complemento">
                        </div>
                    </div>
                </div>
                <div class='row'>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="city" id="city" placeholder="Cidade"
                                value="<?= isset($student) ? $student['city'] : "" ?>" required></input>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="state" id="state" placeholder="Estado"
                                value="<?= isset($student) ? $student['state'] : "" ?>" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
